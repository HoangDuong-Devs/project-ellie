...
import { addSprint, removeSprint, updateSprint } from "@/services/work-api";
import { idSchema, sprintCreateSchema, sprintPatchSchema } from "@/services/work-api-schemas";
...
export const Route = createFileRoute("/api/work/sprints")({
  server: {
    handlers: {
      GET: async ({ request }) => {
